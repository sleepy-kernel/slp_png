...
- AVX2, SSE2 support
- Still depends on zlib (in prgress to remove from this dependency)
...
- Performance is already high.
    - In current version deflate/inflate runtime is more than 80% of the total runtime even at compression level 1
